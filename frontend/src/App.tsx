      ...
      <div className="mx-auto flex h-16 max-w-4xl items-center justify-between px-5">
        ...
        <div className="flex items-center gap-1 text-slate-600 dark:text-white/60">
          <Tooltip.Provider delayDuration={250}>
            <Tooltip.Root><Tooltip.Trigger asChild><a className="grid size-10 place-items-center rounded-xl hover:bg-black/5 hover:text-slate-900 dark:hover:bg-white/10 dark:hover:text-white" href="https://github.com/KevinAntonioWiyonoLauw" target="_blank" rel="noreferrer" aria-label="Repositori GitHub">⌘</a></Tooltip.Trigger><Tooltip.Portal><Tooltip.Content side="bottom" sideOffset={8} collisionPadding={12} className="relative z-[9999] rounded-lg bg-white px-2 py-1 text-xs text-black shadow-lg">Repositori GitHub</Tooltip.Content></Tooltip.Portal></Tooltip.Root>
